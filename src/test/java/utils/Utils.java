...
public class Utils {
    ...
    public static void doScrollPixels(WebDriver driver){
    ...
    public void saveJsonList(String username, String password, String empId) throws IOException, ParseException {
...
//        utils.saveJsonList("user", "pass", "1321");
